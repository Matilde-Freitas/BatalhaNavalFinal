...
public class ManageStats
{
	public static void printMed(int[] jogadasTotal, int numJogo)
	{
		if (numJogo == 0)
		{
			System.out.println("Média de jogadas por partida: N/A");
		}
	...
	public static void printPerc(char[] resultado, int numJogo, int[] jogadasTotal, char vitoria, char derrota,
			char abandono)
	{

		if (numJogo == 0)
		{
			System.out.println("Percentagem de vitórias: N/A");
			System.out.println("Percentagem de derrotas: N/A");
			System.out.println("Percentagem de abandonos: N/A");
		}
	...
	public static void printStatsTotal(char[] resultado, int numJogo, int[] jogadasTotal)
	{
		...
		if (numJogo == 0)
		{
			System.out.print("Número do jogo:     N/A");

			System.out.println();
			System.out.print("Resultado:          N/A");

			System.out.println();
			System.out.print("Jogadas:            N/A");
